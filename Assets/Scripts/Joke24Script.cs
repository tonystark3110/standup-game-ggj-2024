...
public class Joke24Script : MonoBehaviour
{
    ...
    public void run()
    {
        ...
        StartCoroutine(Joke24Sequence());
    }

    IEnumerator Joke24Sequence()
    {
        Debug.Log("tell the joke");

        yield return StartCoroutine(TellJoke24());

        Debug.Log("Joke 24 is completed");
    }

    IEnumerator TellJoke24()
    {
