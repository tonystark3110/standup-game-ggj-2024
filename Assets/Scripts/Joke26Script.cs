...
public class Joke26Script : MonoBehaviour, JokeInterface
{
    ...
    public Joke26Script()
    {
        ButtonText = "Did you know"; //put the text for the prompt button here
    ...
    public void run()
    {
        ...
        StartCoroutine(Joke26Sequence());
    }

    IEnumerator Joke26Sequence()
    {
        Debug.Log("tell the joke");

        yield return StartCoroutine(TellJoke26());

        Debug.Log("Joke 26 is completed");
    }

    IEnumerator TellJoke26()
    {
