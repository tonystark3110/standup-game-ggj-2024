...
public class Joke9Script : MonoBehaviour, JokeInterface
{
    ...
    public void run()
    {
        ...
        StartCoroutine(Joke9Sequence());
    }

    IEnumerator Joke9Sequence()
    {
        Debug.Log("tell the joke");

        yield return StartCoroutine(TellJoke9());

        Debug.Log("Joke 9 is completed");
    }

    IEnumerator TellJoke9()
    {
