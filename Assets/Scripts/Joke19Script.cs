...
public class Joke19Script : MonoBehaviour, JokeInterface
{
    ...
    public void run()
    {
        ...
        StartCoroutine(Joke19Sequence());
    }

    IEnumerator Joke19Sequence()
    {
        Debug.Log("tell the joke");

        yield return StartCoroutine(TellJoke19());

        Debug.Log("Joke 19 is completed");
    }

    IEnumerator TellJoke19()
    {
